...
import { o as organization, I as InferMember, a as InferInvitation, T as Team, b as Organization, M as Member, c as Invitation } from '../../shared/better-auth.B8UMAJn3.mjs';
...
import { T as FieldAttribute, f as BetterAuthOptions, B as BetterAuthPlugin } from '../../shared/better-auth.CkIbScAE.mjs';
...
import { a as apiKey } from '../../shared/better-auth.Cmv42WOT.mjs';
    ...
    getActions: ($fetch: _better_fetch_fetch.BetterFetch) => {
        ...
        organization: {
            checkRolePermission: <R extends O extends {
                ...
                role: R;
                permission: { [key in keyof (O["ac"] extends AccessControl<infer S extends Statements> ? S extends Record<string, any[]> ? S & {
                    readonly organization: readonly ["update", "delete"];
                    readonly member: readonly ["create", "update", "delete"];
                    readonly invitation: readonly ["create", "cancel"];
                    readonly team: readonly ["create", "update", "delete"];
                    ...
                    readonly invitation: readonly ["create", "cancel"];
                    readonly team: readonly ["create", "update", "delete"];
                })]?: (O["ac"] extends AccessControl<infer S extends Statements> ? S extends Record<string, any[]> ? S & {
                    readonly organization: readonly ["update", "delete"];
                    readonly member: readonly ["create", "update", "delete"];
                    readonly invitation: readonly ["create", "cancel"];
                    readonly team: readonly ["create", "update", "delete"];
