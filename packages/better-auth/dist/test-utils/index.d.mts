...
import { I as IsSignal, d as InferRoute, c as InferErrorCodes } from '../shared/better-auth.CfiWBjV1.mjs';
...
import { A as Auth, b as InferAPI } from '../shared/better-auth.BE-iB4_Z.mjs';
...
declare function getTestInstanceMemory<O extends Partial<BetterAuthOptions>, C extends BetterAuthClientOptions>(options?: O, config?: {
    ...
    auth: Auth<O extends undefined ? {
        ...
        secret: string;
        database: ((options: BetterAuthOptions) => packages_core_dist_shared_core_BJPBStdk.i<BetterAuthOptions>) | {
            db: Kysely<unknown>;
            type: "postgres";
        } | {
            db: Kysely<unknown>;
    ...
    db: packages_core_dist_shared_core_BJPBStdk.i<BetterAuthOptions>;
}>;
